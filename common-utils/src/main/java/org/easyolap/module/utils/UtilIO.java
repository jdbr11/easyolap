...
public final class UtilIO {
	...
	/**
	 * Copy an InputStream to an OutputStream, optionally closing either the
	 * input or the output.
	 * 
	 * @param in
	...
	/**
	 * Copy a Reader to a Writer, optionally closing either the input or the
	 * output.
	 * 
	 * @param reader
	 ...
	 * java. This uses a default {@link Charset UTF-8} charset.
	 * 
	 * @param bytes
	...
	/**
	 * Convert a byte array to a string; consistently uses \n line endings in
	 * java. The conversion is limited to the specified offset/length pair, and
	 * uses a default {@link Charset UTF-8} charset.
	 * 
	 * @param bytes
	 *            the array of bytes to convert
	 * @param offset
	 ...
	 * Convert a byte array to a string; consistently uses \n line endings in
	 * java. The conversion is limited to the specified offset/length pair, and
	 * uses the requested charset to decode the bytes.
	 * 
	 * @param bytes
	 *            the array of bytes to convert
	 * @param charset
	...
	/**
	 * Convert a byte array to a string, consistently uses \n line endings in
	 * java. The specified {@link Charset charset} is used to decode the bytes.
	 * 
	 * @param bytes
	 *            the array of bytes to convert
	 * @param charset
	 ...
	 * Convert a byte array to a string, consistently uses \n line endings in
	 * java. The conversion is limited to the specified offset/length pair, and
	 * uses the requested {@link Charset charset} to decode the bytes.
	 * 
	 * @param bytes
	 *            the array of bytes to convert
	 * @param offset
	 ...
	 * endings in java. This uses a default {@link Charset UTF-8} charset.
	 * 
	 * @param stream
	...
	public static final String readString(Reader reader) throws IOException {
		try {
			...
			try {
				...
				logger.error("Error closing after reading text: " + e.toString(), e);
			}
		}
	}
	...
	/**
	 * Convert a \n string to a platform encoding. This uses the specified
	 * charset to extract the raw bytes.
	 * 
	 * @param out
	 *            where to write the converted bytes to
	 * @param charset
