...
public final class PropertiesUtil {
	...
	/**
	 * Constructs a PropertiesUtil using a given Properties object as its source
	...
	/**
	 * Loads and closes the given property input stream. If an error occurs, log
	 * to the status logger.
	 *
	 * @param in
	 ...
	 * classpath. The properties specified in this file are used by default. If
	 * a property is not defined in this file, then the equivalent system
	 * property is used.
	 *
	 ...
	 * @return the parsed integer value of the property or {@code defaultValue}
	 ...
	 * @param defaultValue
	 *            the default value to use if the property is undefined
	 * @return the parsed long value of the property or {@code defaultValue} if
	 *         it was undefined or could not be parsed.
	 */
	 ...
	 * string {@code "true"} (case-insensitive), then it is returned as the
	 * boolean value {@code true}. Any other non-{@code null} text in the
	 * property is considered {@code false}.
	 *
	 * @param name
	 *            the name of the property to look up
	...
	/**
	 * Return the system properties or an empty Properties object if an error
	 * occurs.
	 * 
